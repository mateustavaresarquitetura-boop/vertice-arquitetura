(() => {
  ...
  function welcome(){state.started=true;add("Olá! Eu sou o <strong>Vito</strong>, assistente virtual da Vértice. Posso explicar os serviços, as qualificações do Arq. Mateus e ajudar a direcionar seu projeto.");add("Sobre o que você gostaria de conversar?");quick()}
